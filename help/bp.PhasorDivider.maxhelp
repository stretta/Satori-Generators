...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bp.PhasorDivider.maxpat",
					"numinlets" : 1,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 30.0, 164.0, 134.0, 86.0 ],
					"varname" : "bp.PhasorDivider",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 30.0, 268.0, 129.0, 84.0 ],
					"range" : [ -0.1, 1.1 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 30.0, 120.0, 129.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 58.0, 231.0, 20.0 ],
					"text" : "Easily scale phasor time by powers of two"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-8::obj-2::obj-25" : [ "number[8]", "number", 0 ],
			"parameterbanks" : 			{
...
, 			{
				...
				"patcherrelativepath" : "../../Satori-Generators-Private-Reserve/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
