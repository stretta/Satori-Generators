...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 181.0, 140.0, 33.0 ],
					"presentation_linecount" : 2,
					"text" : "selection is remembered with snapshots"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 72.0, 140.0, 20.0 ],
					"text" : "Specify a MIDI input port"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 191.0, 167.5, 140.0, 60.0 ],
					"viewvisibility" : 1
				}
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-13::obj-14" : [ "refresh[2]", "refresh", 0 ],
			"obj-13::obj-2" : [ "MIDIPort", "MIDIPort", 0 ],
			"obj-13::obj-5" : [ "refresh[1]", "refresh", 0 ],
			"parameterbanks" : 			{
