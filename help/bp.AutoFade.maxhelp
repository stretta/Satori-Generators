...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 58.0, 191.0, 20.0 ],
					"text" : "Fade in/out a signal with one click."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 29.0, 112.0, 27.0 ],
					"text" : "bp.AutoFade"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 470.0, 69.0, 29.0 ],
					"varname" : "AudioOutput",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 42.0, 320.0, 69.0, 139.0 ],
					"varname" : "AudioMix",
					"viewvisibility" : 1
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 42.0, 115.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bp.Autofade.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 42.0, 228.0, 140.0, 60.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-4::obj-113" : [ "pan", "Pan", 0 ],
			"obj-4::obj-114" : [ "solo", "Solo", 0 ],
			"obj-4::obj-115" : [ "active", "Active", 0 ],
			"obj-4::obj-116" : [ "gain", "Gain", 0 ],
			"obj-4::obj-30" : [ "qlist", "Qlist", 0 ],
			"obj-4::obj-4" : [ "setname", "Setname", 0 ],
			"obj-5::obj-1" : [ "live.text[34]", "live.text[33]", 0 ],
			"obj-5::obj-4" : [ "live.numbox[45]", "Time", 0 ],
			"parameterbanks" : 			{
...
,
		"dependency_cache" : [ 			{
				"name" : "bp.AutoFade.maxhelp.maxsnap",
...
,
			"snapshotlist" : 			{
				...
				"entries" : [ 					{
						...
						"version" : 2,
						"minorversion" : 0,
						"name" : "bp.AutoFade.maxhelp",
						"origin" : "bp.AutoFade.maxhelp",
						"type" : "patcher",
						"subtype" : "Undefined",
						"embed" : 1,
						"snapshot" : 						{
...
,
						"fileref" : 						{
							"name" : "bp.AutoFade.maxhelp",
							"filename" : "bp.AutoFade.maxhelp.maxsnap",
							"filepath" : "~/Documents/Max 8/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "eab508e8336fa014fd782c4125e2cd3e"
						}
