...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 164.0, 21.0, 17.0 ],
					"text" : "1.0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 222.0, 24.0, 17.0 ],
					"text" : "-1.0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 60.0, 164.0, 107.0, 69.0 ],
					"range" : [ -1.1, 1.1 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 146.0, 406.0, 21.0, 17.0 ],
					"text" : "1.0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 146.0, 464.0, 24.0, 17.0 ],
					"text" : "-1.0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 34.0, 406.0, 107.0, 69.0 ],
					"range" : [ -1.1, 1.1 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 54.0, 97.0, 20.0 ],
					"text" : "Process a signal"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 25.0, 107.0, 27.0 ],
					"text" : "bp.GainBias"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 34.0, 109.0, 62.0, 22.0 ],
					"text" : "phasor~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bp.GainBias.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 34.0, 260.0, 140.0, 121.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-1::obj-106" : [ "live.text[5]", "invert", 0 ],
			"obj-1::obj-109" : [ "number[6]", "scalar", 0 ],
			"obj-1::obj-112" : [ "number[7]", "phase", 0 ],
			"obj-1::obj-3" : [ "number[2]", "bias", 0 ],
			"parameterbanks" : 			{
